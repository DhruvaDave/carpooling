...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <tbody>
                        <tr> <div class="p"><center> <b>Cars</b></center></div> </tr><br>
						<tr>
						<td id="m"> Name </td>
						<td id="m"> Image </td>
						<td id="m"> feature </td>
                       ...
                       <tr>
						...
						<td> <img src="../upload/./<?php echo $v['car_image'];  ?>" style="height:50px" width="100px" >  </td>
 					    <td> <?php echo   $v['car_feature']; ?>  </td>
						<td> <?php echo   $v['car_price']; ?>  </td>
						
						<td> <a href="car.php?cardid=<?php echo $v['car_id']; ?>">DELET </a></td>
						</tr>		         			      
						<?php
